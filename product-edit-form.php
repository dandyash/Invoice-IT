...
{
$id=$_GET['id'];
$q = "SELECT product_name, product_uom from product_master where product_id=$id";
...
if(isset($_POST['submit'])) {
   ...
   $uom = $_POST['address'];
    ...
    $query = "UPDATE product_master SET product_name = '$name' , product_uom = '$uom' WHERE product_id=$id";
...
<?php include('header.php'); ?>
        ...
        <div class="x_content">
              ...
              <div class="item form-group">
                ...
                <input type="text" class="form-control" name="name" value="<?php echo $name; ?>" placeholder="Product Name" autocomplete="off">
                                <span class="text-danger"><?php if (isset($nameErr)){echo $nameErr;}?></span>
              </div>
            </div>
              <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">   Product UOM    <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                <input type="text" class="form-control" name="address" value="<?php echo $uom ?>" placeholder=" Product UOM" autocomplete="off">
