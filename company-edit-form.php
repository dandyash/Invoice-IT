...
$q = "SELECT company_name, company_address, company_phn, company_email, company_gstn,company_pincode,company_website, city_id, state_id, country_id from company_master ";
...
while($row=mysqli_fetch_assoc($res))
{
  ...
  $s = $row['state_id'];
  $ci = $row['city_id'];
  $pin = $row['company_pincode'];
  $ph = $row['company_phn'];
  $mail = $row['company_email'];
  $gst = $row['company_gstn'];
...
if(isset($_POST['submit'])) {
   ...
   $webs = $_POST['website'];
    ...
    $query = "UPDATE `company_master` SET `company_name`='$name',`company_address`='$adr',`country_id`= '$country' , `state_id`= '$state',`city_id`= '$city' ,`company_phn`= '$phn' ,`company_email`= '$mail' ,`company_pincode`= '$pi' ,`company_website`= '$webs' ,`company_gstn`= '$gstn' WHERE 1";
    ...
    echo "<script>alert('Unsuccessfull Updated.');</script>"; 
    }
...
<?php include('header.php'); ?>
        ...
        <div class="x_content">
              ...
              <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                                <input type="text" class="form-control" placeholder="Pincode" value="<?php echo $pin; ?>" name="pinc" minlength="6" maxlength="6" autocomplete="off">
                                <span class="text-danger"><?php if (isset($phnErr)){echo $phnErr;}?></span>
                            </div>
                           </div> 
                           ...
                           <div>
                             ...
                             <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">
                          Company's Website    <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                                <input type="text" class="form-control" placeholder="Company's Website" value="<?php echo $web; ?>" name="website" autocomplete="off">
                                <span class="text-danger"><?php if (isset($phnErr)){echo $phnErr;}?></span>
                            </div>
                           </div> 
