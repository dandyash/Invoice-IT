...
?><div id='bigi' style='text-align: center;'>SALES INVOICE</div><?php
$this->data .= "<table id='company'><tr><td id='co-left'><div id='co-addr'>";
...
if (count($this->notes)>0) {
	...
	$this->data .= "<br><div style='text-align: center;'>Payment Due in 7 days from the date of invoice<br><b>Thank You</b></div>";
	$this->data .= "</div>";
}
