...
if(isset($_POST['submit'])) {
  ...
  $date = $_POST['date'];
    ...
    $query = "INSERT INTO company_master(company_name,  company_address,company_year,country_id, state_id,city_id, company_phn,  company_email, company_pincode , company_website, company_gstn , company_logo)
 values ('$name','$adr','$date','$country','$state','$city','$phn','$mail','$pin','$web','$gstn','0');";
         ...
         <!--     <div class="title_right">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Company Form <small></small></h2>
        ...
        <div class="x_content">
            ...
            <fieldset>
              ...
              <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Company's Name <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                <input type="text" class="form-control" id="name" name="name" value="<?php if(isset($name)){echo $name;}?>" placeholder="Company Name" autocomplete="off">
                                <span class="text-danger"><?php if (isset($nameErr)){echo $nameErr;}?></span>
              </div>
            </div>
              <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Company's Address    <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                <input type="text" class="form-control" id="address" name="address" value="<?php if(isset($adr)){echo $adr;}?>" placeholder="Address" autocomplete="off">
              ...
              <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Company's Year    <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                <input type="date" class="form-control" id="date" name="date" value="<?php if(isset($adr)){echo $adr;}?>" placeholder="Address" autocomplete="off">
                                <span class="text-danger"><?php if (isset($addErr)){echo $addErr;}?></span>
              </div>
            </div>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                                <input type="text" id="phn" name="phn" class="form-control" placeholder="Phone number" value="<?php if(isset($phn)){echo $phn;}?>" name="phone" minlength="10" maxlength="10" autocomplete="off">
              ...
              <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                                <input type="text" id="pin" name="pin" class="form-control" placeholder="Pincode" value="<?php if(isset($pin)){echo $pin;}?>" name="pin" minlength="6" maxlength="6" autocomplete="off">
                                <span class="text-danger"><?php if (isset($pinErr)){echo $pinErr;}?></span>
                            </div>
                           </div> 

                            <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Company's website
                        <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                                <input type="text" id="web" name="web" class="form-control" placeholder="Website" value="<?php if(isset($web)){echo $web;}?>" name="web" autocomplete="off">
                                <span class="text-danger"><?php if (isset($phnErr)){echo $phnErr;}?></span>
                            </div>
                           </div> 
