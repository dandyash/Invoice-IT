...
if (isset($_GET['delete'])) {
    $id = $_GET['delete'];
    $delete = mysqli_query($conn,"DELETE FROM invoice_master WHERE invoice_id = '$id'");
}
...

{
    ...
    $del = mysqli_query($conn,"SELECT issue_date , due_date  FROM invoice_master WHERE u_id = $id;");
}
                    ...
                    <div class="col-md-12 col-sm-12 ">
                        <div class="x_panel">
                            ...
                            <table class="table table-hover" id="sample-table-1">
								...
								<td>".$res['due_date']."</td>
								<td><a class='btn btn-outline-primary' href ='view-more.php?view=$res[invoice_id]'> View More Details</a>
                                    <a class='btn btn-outline-danger' href ='view-invoice.php?delete=$res[invoice_id]'> Delete</a>
                                </td>
								</tr>
							";
                                    }
